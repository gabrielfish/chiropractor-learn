...
const services = {
  ["ssr"]: lazyService(() => import("./_ssr/index-C_Z7zzNK.mjs"))
};
...
const _lazy_YP5BoT = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_YP5BoT };
  return ((_m, p) => {

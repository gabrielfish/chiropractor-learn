...
import { s as setUserRole, a as setMemberActive, l as listMembers } from "./members.functions-Ity8eq-D.mjs";
...
import { _ as Link2, c as Search, U as Users, O as UserCheck, a7 as UserX, L as LoaderCircle, g as Check, h as Copy, S as ShieldCheck } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 pt-14 px-4 pb-4 sm:px-8 sm:pb-8 md:p-8 overflow-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => setInviteOpen(true), className: "bg-gold text-gold-foreground hover:bg-gold/90 font-semibold gap-2 w-full sm:w-auto h-12 sm:h-10", children: [

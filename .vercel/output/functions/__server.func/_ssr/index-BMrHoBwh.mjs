...
import { c as Search, X, M as Menu, G as Globe, d as Sparkles, R as RefreshCw, B as BookOpen, e as ArrowRight, f as Bot, g as Check, h as Copy, Q as Quote, P as Play, F as FileText, U as Users, a as Award, i as Lock, C as CalendarDays } from "../_libs/lucide-react.mjs";
...
function LandingSearchModal({
  ...
  const { data, isFetching } = useQuery({
    ...
    queryFn: () => search({ data: { q: debounced.length > 0 ? debounced : "a", featured: debounced.length === 0 } }),
    enabled: open,
    staleTime: 3e4
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-3xl p-0 gap-0 overflow-hidden bg-background border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border bg-primary text-primary-foreground px-5 flex items-center gap-3 h-[60px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-6 w-6 text-gold shrink-0" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-h-[60vh] overflow-y-auto p-5 bg-background", children: [
      isFetching && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-sm text-muted-foreground py-10", children: "Searching…" }),
      !isFetching && debounced.length === 0 && results.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-sm text-muted-foreground py-12", children: "Start typing to search Ryan's full teaching library." }),
      !isFetching && results.length > 0 && isFeatured && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: debounced.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-medium", children: "Here are some of Ryan's most popular teachings:" }) }),
      !isFetching && results.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-4", children: results.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
      ...
      !isFetching && isFeatured && results.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-xl border border-gold/30 bg-gold/5 p-5 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mb-3", children: "Want to learn more? Talk to the DCPG team." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: BOOKING_URL, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "bg-gold text-gold-foreground hover:bg-gold/90 font-semibold gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border bg-muted/40 p-5 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", onClick: () => onOpenChange(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-gold text-gold-foreground hover:bg-gold/90 font-semibold", children: "Sign Up for Access" }) })
      ] })
    ] })
  ] }) });
}
...
function LandingPage() {
  ...
  const [mcpCopied, setMcpCopied] = reactExports.useState(false);
  function copyMcpUrl() {
    navigator.clipboard.writeText(`https://${PUBLIC_MCP_URL}`);
    setMcpCopied(true);
    setTimeout(() => setMcpCopied(false), 2e3);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 border-b border-border bg-background/90 backdrop-blur", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 h-16 flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setSearchOpen(true), className: "hidden lg:flex items-center gap-2 h-10 px-4 rounded-lg border border-border bg-muted/50 text-muted-foreground hover:border-gold hover:text-gold transition-colors text-sm w-56", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-4 w-4 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-left truncate", children: "Search Ryan's library..." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", "aria-label": "Search courses", onClick: () => setSearchOpen(true), className: "lg:hidden text-foreground hover:text-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-5 w-5" }) })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative text-white overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-5xl mx-auto px-5 sm:px-6 py-14 sm:py-20 md:py-28 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl sm:text-4xl md:text-6xl font-extrabold leading-tight mb-5 sm:mb-6", children: "Ryan Rieder's complete teaching library, built for practice owners ready to scale to 7 figures." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg md:text-xl text-primary-foreground/80 max-w-2xl mx-auto mb-8 sm:mb-10", children: "Search and watch Ryan Rieder's complete teaching library — unlimited access, built exclusively for practice owners." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 max-w-xl mx-auto w-full px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setSearchOpen(true), className: "w-full h-[60px] flex items-center gap-3 px-5 rounded-xl bg-white/10 border border-white/20 hover:border-gold/60 hover:bg-white/15 transition-all text-left group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-6 w-6 text-gold shrink-0 group-hover:scale-110 transition-transform" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-primary-foreground/60 text-base", children: "Search Ryan's teaching library..." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-xs font-semibold bg-gold/20 text-gold px-3 py-1 rounded-full", children: "Search" })
        ] }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-6xl mx-auto px-6 pb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block mb-3 px-3 py-1 rounded-full bg-gold/15 text-gold text-xs font-semibold tracking-wide uppercase", children: "Free for practice owners" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-extrabold text-foreground mb-3", children: "Free tools & resources" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Practical tools built by DCPG to help you grow your practice — no credit card, no catch." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-5", children: [{
        ...
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-6 w-6" }),
        title: "Content Builder",
        desc: "Generate social media content for your practice in seconds",
        href: "https://contentgen.dcpracticegrowth.com",
        cta: "Build content"
      }, {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "h-6 w-6" }),
      ...
      }].map((tool) => /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: tool.href, target: "_blank", rel: "noopener noreferrer", className: "group flex flex-col justify-between rounded-2xl bg-primary p-7 hover:bg-primary/90 transition-colors", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center rounded-xl bg-gold/20 text-gold p-3 mb-5 group-hover:bg-gold/30 transition-colors", children: tool.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-primary-foreground mb-2", children: tool.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 text-sm leading-relaxed", children: tool.desc })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex items-center gap-1.5 text-gold text-sm font-semibold group-hover:gap-2.5 transition-all", children: [
          tool.cta,
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4" })
        ] })
      ] }, tool.title)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "max-w-6xl mx-auto px-6 pb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-gold/30 bg-gold/5 p-8 sm:p-10 flex flex-col sm:flex-row gap-8 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 rounded-xl bg-gold/20 p-4 text-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "h-8 w-8" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block mb-3 px-3 py-1 rounded-full bg-gold/20 text-gold text-xs font-semibold tracking-wide uppercase", children: "Claude AI Integration" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl sm:text-3xl font-extrabold text-foreground mb-3", children: "Ask Claude About Practice Growth" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6 max-w-xl", children: "Connect Ryan's free teaching library to Claude AI and get instant answers to any practice growth question." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0 rounded-lg border border-border bg-background px-4 py-2.5 font-mono text-sm text-foreground truncate", children: PUBLIC_MCP_URL }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: copyMcpUrl, className: "shrink-0 flex items-center gap-1.5 h-10 px-4 rounded-lg bg-gold text-gold-foreground hover:bg-gold/90 font-semibold text-sm transition-colors", children: [
            mcpCopied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "h-4 w-4" }),
            mcpCopied ? "Copied!" : "Copy"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mb-2", children: "How to connect:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "text-sm text-muted-foreground space-y-1 list-decimal list-inside", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
            "Open Claude → ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Settings → Customize → Connectors" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
            "Click ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Add" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Paste the URL above and save" })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/40 border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-extrabold text-foreground mb-3", children: "Real results from real practice owners" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-4xl mx-auto px-6 py-20 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-8 max-w-xl mx-auto", children: "Join the practice owners using DCPG to build stronger, more profitable practices." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "lg", className: "bg-gold text-gold-foreground hover:bg-gold/90 font-semibold h-12 px-8 w-full sm:w-auto", children: "Sign Up" }) }),

...
import { F as FileDropzone, u as uploadAvatar } from "./storage-CFoQRfiU.mjs";
...
import { a as getMyCertificates } from "./certificates.functions-BprlTGIO.mjs";
import { c as Route$c } from "./router-QLVMFfDU.mjs";
import "../_libs/seroval.mjs";
import { L as LoaderCircle, l as BotMessageSquare, g as Check, h as Copy, a as Award, m as ExternalLink, n as ChevronDown, o as ChevronUp } from "../_libs/lucide-react.mjs";
...
createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).handler(createSsrRpc("8363586f12795f957760bfabff39dca05b4e0099963be6575aad1a91ab62c774"));
function Section({
  title,
  description,
  children
...
function ProfilePage() {
  ...
  const copyUrl = async () => {
    await navigator.clipboard.writeText(MCP_MEMBER_URL);
    setCopiedUrl(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-3xl mx-auto px-4 sm:px-6 py-8 md:py-12 space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Connect Claude to Ryan's Library", description: "Give Claude direct access to the full DCPG teaching library — search lessons, get transcripts, and get personalised recommendations. No token required.", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 rounded-lg bg-muted/50 border border-border p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(BotMessageSquare, { className: "h-5 w-5 shrink-0 text-primary mt-0.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground space-y-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "In Claude, go to ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Settings → Integrations → Add MCP Server" }),
            " and paste the URL below. No API key needed."
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "MCP Server URL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { readOnly: true, value: MCP_MEMBER_URL, className: "font-mono text-sm min-w-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "outline", onClick: copyUrl, className: "shrink-0", title: "Copy URL", children: copiedUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4 text-green-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "h-4 w-4" }) })
          ] })
        ] })
      ] }),

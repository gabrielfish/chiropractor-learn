...
import { y as youtubeThumbnail, F as FileDropzone, a as uploadContentFile, s as slugify } from "./storage-CFoQRfiU.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { A as AdminSidebar } from "./AdminSidebar-B6Sw1hS_.mjs";
import { P as PublishNotificationModal, s as saveCourse } from "./courses.functions-ByKUMNqi.mjs";
import { s as syncContentToAlgolia, a as syncCourseToAlgolia } from "./algolia-sync.functions-Ba0tDuby.mjs";
import { u as useServerFn } from "./useServerFn-DL2oePlL.mjs";
import { e as Route$9 } from "./router-QLVMFfDU.mjs";
import "../_libs/seroval.mjs";
import { z as Plus, w as GraduationCap, H as Pencil, X, L as LoaderCircle, o as ChevronUp, n as ChevronDown, J as GripVertical } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 pt-14 px-4 pb-4 sm:px-6 sm:pb-6 md:p-10 overflow-x-hidden min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
      ...
      contentMode === "lesson" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-xl bg-card border border-border p-4 sm:p-6 shadow-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          ...
          form.content_type !== "book" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-2", children: [
          ...
          form.content_type === "book" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Book Cover Image" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(FileDropzone, { label: "Upload book cover", accept: "image/*", uploaded: !!form.thumbnail_url, hint: "JPG, PNG, or WebP — portrait orientation recommended", onFile: async (file) => {
              try {
                const url = await uploadContentFile("thumbnail", file);
                setForm((f) => ({
                  ...f,
            ...
            form.thumbnail_url && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: form.thumbnail_url, alt: "Book cover preview", className: "h-32 rounded-md border border-border object-cover" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { children: [
              "PDF",
              form.content_type === "book" ? " (Book file)" : ""
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(FileDropzone, { label: form.content_type === "book" ? "Upload book PDF" : "Upload PDF", accept: "application/pdf", uploaded: !!form.pdf_url, hint: form.content_type === "book" ? "The downloadable book PDF members will receive" : "Drag and drop or click to select a PDF", onFile: async (file) => {
              try {

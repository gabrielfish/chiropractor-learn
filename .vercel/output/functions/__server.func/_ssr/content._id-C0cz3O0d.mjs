...
import { b as checkAndIssueCategory } from "./certificates.functions-BprlTGIO.mjs";
import { g as Route$7 } from "./router-QLVMFfDU.mjs";
import "../_libs/seroval.mjs";
import { A as ArrowLeft, a0 as Book, m as ExternalLink, D as Download, L as LoaderCircle, t as CircleCheck, F as FileText, $ as Facebook, a1 as MessageCircle, a2 as Twitter, k as Linkedin } from "../_libs/lucide-react.mjs";
...
function ContentDetail() {
  ...
  if (contentQ.isError) {
    const errMsg = contentQ.error?.message ?? "Could not load lesson.";
    console.error("[content detail] render error:", errMsg);
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MemberNav, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 py-20 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-destructive font-medium mb-2", children: "Could not load lesson" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-mono bg-muted px-3 py-2 rounded mb-4 text-left break-all", children: errMsg }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard", className: "mt-4 inline-flex items-center text-sm text-primary hover:underline", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-6 md:py-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
          isBook ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-4", children: item.thumbnail_url ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.thumbnail_url, alt: item.title, className: "max-h-[480px] rounded-xl object-contain shadow-2xl border border-border" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center w-full aspect-[3/4] max-w-xs rounded-xl bg-primary/10 border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Book, { className: "h-24 w-24 text-primary/30" }) }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(VideoPlayer, { videoUrl: item.video_url, title: item.title, posterUrl: item.thumbnail_url }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6", children: [
            ...
            (item.display_author_name || item.author?.full_name) && (() => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5 p-3 rounded-lg bg-card border border-border", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-wider text-gold font-semibold", children: isBook ? "Written by" : "Taught by" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 mt-6 [&>*]:min-h-[44px] sm:[&>*]:min-h-0", children: isBook ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              pdfUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: () => window.open(pdfUrl, "_blank"), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-4 w-4 mr-2" }),
                  " Read Online"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-gold text-gold-foreground hover:bg-gold/90", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: pdfUrl, download: true, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                pdfUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: pdfUrl, target: "_blank", rel: "noopener noreferrer", download: true, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card border border-border p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold mb-3", children: isBook ? "About this book" : "Resources" }),
            isBook ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              item.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/80 leading-relaxed", children: item.description }),
              pdfUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-foreground/70 pt-1 border-t border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Book, { className: "h-4 w-4 text-gold shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "PDF available for download" })
              ] })
              ...
              pdfUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2 text-foreground/80", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-primary text-primary-foreground p-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary-foreground/80 mb-3", children: isBook ? "Explore more resources in the library." : "Mark lessons complete to earn category certificates." }),

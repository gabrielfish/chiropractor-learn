...
import { L as LoaderCircle, G as Globe, d as Sparkles, v as Calendar, U as Users, D as Download, c as Search, w as GraduationCap, g as Check, h as Copy, X, r as ChevronRight, I as Icons, x as Folder, t as CircleCheck, y as Share2, B as BookOpen, F as FileText, P as Play } from "../_libs/lucide-react.mjs";
...
import { d as Route$b } from "./router-QLVMFfDU.mjs";
...
function McpBanner() {
  const [dismissed, setDismissed] = reactExports.useState(() => sessionStorage.getItem("mcp-banner-dismissed") === "1");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gold/10 border-b border-gold/30 px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto flex flex-wrap items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg shrink-0", children: "🤖" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex-1 min-w-0 text-sm text-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Pro tip:" }),
      " Connect Claude AI to Ryan's full teaching library! Add",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs bg-background border border-border rounded px-1.5 py-0.5 break-all", children: MEMBER_MCP_URL }),
      " ",
      "to Claude → ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Settings → Customize → Connectors" }),
      " for instant AI-powered access to all teachings."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: copy, className: "flex items-center gap-1.5 h-8 px-3 rounded-lg bg-gold text-gold-foreground hover:bg-gold/90 font-semibold text-xs transition-colors", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: dismiss, className: "h-8 w-8 flex items-center justify-center rounded-lg hover:bg-muted transition-colors text-muted-foreground hover:text-foreground", "aria-label": "Dismiss", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-4 w-4" }) })
    ] })
  ] }) });
}
function Dashboard() {
  ...
  const booksQ = useQuery({
    ...
    queryFn: async () => {
      const {
        data,
        error
      } = await supabase.from("content").select("id, title, book_url, book_name, thumbnail_url, pdf_url").eq("status", "published").eq("content_type", "book");
      if (error) throw error;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(McpBanner, {}),
        ...
        !query && contentFilter !== "courses" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-12", children: [
          ...
          !booksQ.isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [{
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative rounded-xl bg-primary border border-primary/80 overflow-hidden hover:border-gold/60 transition-all shadow-card flex", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-28 sm:w-32 shrink-0 relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: coverSrc, alt: book.title, className: "w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" }) }),

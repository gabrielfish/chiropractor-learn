...
const appCss = "/assets/styles-CF7Y061J.css";
...
const $$splitComponentImporter$k = () => import("./team-signup-y8_NdEjN.mjs");
const Route$k = createFileRoute("/team-signup")({
  ssr: false,
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$j = () => import("./signup-DXi7xJwe.mjs");
...
const $$splitComponentImporter$i = () => import("./reset-password-DAxsQC-N.mjs");
...
const $$splitComponentImporter$h = () => import("./login-24Q3XOLw.mjs");
...
const $$splitComponentImporter$f = () => import("./index-BMrHoBwh.mjs");
...
const $$splitComponentImporter$e = () => import("./signup.confirm-xp1W23Aw.mjs");
const searchSchema$1 = objectType({
  email: stringType().optional()
});
const Route$e = createFileRoute("/signup/confirm")({
...
const $$splitComponentImporter$d = () => import("./certificate._id-s2wKnWpE.mjs");
const Route$d = createFileRoute("/certificate/$id")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$c = () => import("./profile-C-SAQs_B.mjs");
const Route$c = createFileRoute("/_authenticated/profile")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$b = () => import("./dashboard-B7BKSgCb.mjs");
...
const $$splitComponentImporter$a = () => import("./admin-BFsOu0JM.mjs");
...
const $$splitComponentImporter$9 = () => import("./admin.index-BEyyk_iw.mjs");
...
const $$splitComponentImporter$8 = () => import("./course._id-lLsNUAP5.mjs");
const Route$8 = createFileRoute("/_authenticated/course/$id")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./content._id-C0cz3O0d.mjs");
const Route$7 = createFileRoute("/_authenticated/content/$id")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$6 = () => import("./admin.settings-DWg1_3gz.mjs");
...
const $$splitComponentImporter$5 = () => import("./admin.notifications-DJH-_sT7.mjs");
const Route$5 = createFileRoute("/_authenticated/admin/notifications")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$4 = () => import("./admin.members-Cg0AplqE.mjs");
const Route$4 = createFileRoute("/_authenticated/admin/members")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$3 = () => import("./admin.library-UwOR4ozE.mjs");
const Route$3 = createFileRoute("/_authenticated/admin/library")({
  head: () => ({
    meta: [{
  ...
  validateSearch: (search) => ({
    tab: search.tab === "courses" ? "courses" : "lessons",
    page: Number(search.page) > 0 ? Number(search.page) : 1
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin.books-D5T9ia-o.mjs");
const Route$2 = createFileRoute("/_authenticated/admin/books")({
  head: () => ({
    meta: [{
      title: "Book Content — DCPG Admin"
    }]
  }),
  beforeLoad: ({
    context
...
const $$splitComponentImporter$1 = () => import("./admin.authors-DhN8Mond.mjs");
...
const $$splitComponentImporter = () => import("./admin.analytics-Cwj9EBi2.mjs");
...
const TeamSignupRoute = Route$k.update({
  id: "/team-signup",
  path: "/team-signup",
...
const SignupConfirmRoute = Route$e.update({
  id: "/confirm",
  path: "/confirm",
  getParentRoute: () => SignupRoute
});
const CertificateIdRoute = Route$d.update({
  id: "/certificate/$id",
  path: "/certificate/$id",
  getParentRoute: () => Route$l
});
const AuthenticatedProfileRoute = Route$c.update({
  id: "/profile",
  path: "/profile",
...
const AuthenticatedAdminRoute = Route$a.update({
  id: "/admin",
  path: "/admin",
  getParentRoute: () => AuthenticatedRouteRoute
});
...
const AuthenticatedCourseIdRoute = Route$8.update({
  id: "/course/$id",
  path: "/course/$id",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedContentIdRoute = Route$7.update({
  id: "/content/$id",
  path: "/content/$id",
  getParentRoute: () => AuthenticatedRouteRoute
});
...
const AuthenticatedAdminNotificationsRoute = Route$5.update({
  id: "/notifications",
  path: "/notifications",
  getParentRoute: () => AuthenticatedAdminRoute
});
const AuthenticatedAdminMembersRoute = Route$4.update({
  id: "/members",
  path: "/members",
  getParentRoute: () => AuthenticatedAdminRoute
});
const AuthenticatedAdminLibraryRoute = Route$3.update({
  id: "/library",
  path: "/library",
  getParentRoute: () => AuthenticatedAdminRoute
});
const AuthenticatedAdminBooksRoute = Route$2.update({
  id: "/books",
  path: "/books",
  getParentRoute: () => AuthenticatedAdminRoute
});

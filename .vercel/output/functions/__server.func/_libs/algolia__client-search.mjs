...
import { I as IndicesInSameAppError, f as IndexNotFoundError, h as IndexAlreadyExistsError, s as serializeQueryParameters, c as createTransporter, g as getAlgoliaAgent, v as validateRequired, A as ApiError, D as DEFAULT_REPLACE_ALL_OBJECTS_MAX_RETRIES, i as createIterablePromise, b as createMemoryCache, d as createNullCache, e as createNullLogger, j as shuffle, a as createAuth } from "./algolia__client-common.mjs";
import { c as createHttpRequester } from "./algolia__requester-node-http.mjs";
...
const client_search_star = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  apiClientVersion,
  searchClient
});
export {
  apiClientVersion as a,
  client_search_star as c,
  searchClient as s
};

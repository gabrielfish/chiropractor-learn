import { D as DEFAULT_REPLACE_ALL_OBJECTS_MAX_RETRIES } from "./algolia__client-common.mjs";
import { a as abtestingV3Client, b as abtesting_star } from "./algolia__abtesting.mjs";
import { a as abtestingClient, c as client_abtesting_star } from "./algolia__client-abtesting.mjs";
import { a as analyticsClient, c as client_analytics_star } from "./algolia__client-analytics.mjs";
import { i as insightsClient, c as client_insights_star } from "./algolia__client-insights.mjs";
import { p as personalizationClient, c as client_personalization_star } from "./@algolia/client-personalization+[...].mjs";
import { q as querySuggestionsClient, c as client_query_suggestions_star } from "./@algolia/client-query-suggestions+[...].mjs";
import { s as searchClient, a as apiClientVersion, c as client_search_star } from "./algolia__client-search.mjs";
import { i as ingestionClient, a as ingestion_star } from "./algolia__ingestion.mjs";
import { m as monitoringClient, a as monitoring_star } from "./algolia__monitoring.mjs";
import { r as recommendClient, a as recommend_star } from "./algolia__recommend.mjs";
import "zlib";
import "./algolia__requester-node-http.mjs";
import "http";
import "https";
import "stream";
import "url";
...
function algoliasearch(appId, apiKey, options) {
  ...
  return {
    ...client,
    async saveObjectsWithTransformation({ indexName, objects, waitForTasks, maxRetries }, requestOptions) {
    ...
    async partialUpdateObjectsWithTransformation({ indexName, objects, createIfNotExists, waitForTasks, maxRetries }, requestOptions) {
      if (!ingestionTransporter) {
        throw new Error(
          "`transformationOptions` must be set in the client config before calling this method. It defaults to the Ingestion API defaults. See https://www.algolia.com/doc/libraries/sdk/methods/ingestion/"
        );

...
export {
  ApiError as A,
  DEFAULT_REPLACE_ALL_OBJECTS_MAX_RETRIES as D,
  IndicesInSameAppError as I,
  createAuth as a,
  createMemoryCache as b,
  createTransporter as c,
  createNullCache as d,
  createNullLogger as e,
  IndexNotFoundError as f,
  getAlgoliaAgent as g,
  IndexAlreadyExistsError as h,
  createIterablePromise as i,
  shuffle as j,
  serializeQueryParameters as s,
